...
import { clip } from '../../utils/func'
import { Rect, type RectDelta } from '../../utils/rect'
...
export default class QuarterLayout implements WindowsLayout {
  ...
  public apply (
    ...
    const gap1 = Math.floor(this.config.gaps.tileLayout / 2)
    const gap2 = this.config.gaps.tileLayout - gap1
